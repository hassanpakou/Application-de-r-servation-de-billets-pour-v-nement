...
export async function loadUserManagement() {
    try {
        ...
        console.error('Erreur lors du chargement de la gestion des utilisateurs :', error);
        alert('Impossible de charger la gestion des utilisateurs. Veuillez réessayer.');
    }
}
